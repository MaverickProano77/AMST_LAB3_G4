    package com.example.amst_lab3_appapi;
...
import java.util.Map;
    ...
    private void revisarSensores(){
        ...
        String url_temp = "https://amst-labapi.herokuapp.com/api/sensores/1";
        ...
        mQueue.add(request);
        String url_humedad="https://amst-labapi.herokuapp.com/api/sensores/2";
        ...
        String url_peso = "https://amst-labapi.herokuapp.com/api/sensores/3";
